...
/**
 * A class for a kind of Model.Truck that can transport cars on its flatbed.
 */
...
public class CarTransporter extends Truck {
    ...
    public void openRamp() {
        if (!this.isMoving()) {
            ...
            System.out.println("Model.Truck is moving! Cannot open ramp!");
        }
    }
    ...
    public void closeRamp() {
        if (!this.isMoving()) {
            ...
            System.out.println("Model.Truck is moving! Cannot close ramp!");
        }
    }
